...
A very common task is to convert a JSON response from the web service into user-defined class instances. JSONSwift provides a set of Utils methods and protocol to help complete this task.
